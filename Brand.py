...
\033[1;91m☞ Author     : AHMED RAHMAN
\033[1;92m☞ WhatsApp   : Dimuna🙈
\033[1;95m☞ Facebook    : https://www.facebook.com/4HM3DR4HM4N
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Commandl')
	print (S + '[' + P + '☞3' + S + ']' + S + ' B4_WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num Dimuna✓')
	    psb('WellCome To AHMEDBRAND)
	    psb('Congratulations Ahmedbrand Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 4HM3DR4HM4N✓')
	    psb('🔓Password ☆ Nunubaba✓')
	    psb('✓')
